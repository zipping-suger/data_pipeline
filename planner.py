...
def _check_tool_collision(gripper_pose: SE3, obstacles: List[Union[Cuboid, Cylinder]], tools: List[Tool], buffer=0.03) -> bool:
    """
...
class Planner:
    ...
    def load_envs_attached_tools(self, obstacles, attached_tools):
